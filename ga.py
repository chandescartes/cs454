...
class GA(object):
    ...
    def evolve(self):
        ...
        if self.verbose:
            print("  G: {0}     \tScore: {1} \t{2}%".format(self.gen, round(self.optimum.fitness,2), round(self.eval_tot/self.eval_lim*100, 1)))
        ...
        print("Score: {1} \tXPath: {2}".format(self.optimum.xpath, round(self.optimum.fitness,2)))
...
class Individual(object):
    ...
    def eval(self):
        # TODO
        if not self.type:
            self.fitness = len(self.ga.DOM.xpath(self.xpath))
